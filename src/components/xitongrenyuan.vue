  ...
  <div>
    <el-card>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="2">
          <el-button type="primary" @click="searchUserFunction"
            >查询</el-button
          ></el-col
        >
        <el-col :span="4">
          <el-button type="success" @click="addUserAdmin"
            >增加管理员</el-button
          ></el-col
        >
      </el-row>
      ...
      <el-row :gutter="20">
        <el-col :span="24">
          <i class="el-icon-menu"></i><span>系统人员列表</span>
        </el-col>
      </el-row>
      <!-- 表格 -->
      <template>
        <el-table :data="tableData" style="width: 100%" border stripe>
          ...
          <el-table-column label="权限">
            <template slot-scope="scope">
              <!-- {{scope.row.powerCode}} -->
              <el-tag v-if="scope.row.powerCode == 1" effect="dark"
                >系统管理员</el-tag
              >
              <el-tag
                type="success"
                v-if="scope.row.powerCode == 2"
                effect="dark"
                >课程管理员</el-tag
              >
            </template>
          ...
          <el-table-column fixed="right" label="操作" width="100">
            <template slot-scope="scope">
              <el-button
                @click="handle_DeleteList(scope.row)"
                type="text"
                size="small"
                >删除</el-button
              >
